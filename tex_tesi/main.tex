...
\acro{AT}{Approximately Timed}
\acro{LT}{Loosely Timed}
\acro{UT}{Untimed TLM}
\acro{CA}{Cycle Accurate} 
\acro{$M^I_{TLM}$}{TLM Initiator Model}
\acro{$M^T_{TLM}$}{TLM Target Model}
\acro{$M^T_{RTL}$}{RTL Target Model}
