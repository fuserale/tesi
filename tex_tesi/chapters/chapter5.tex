...
%L'implementazione del codice è fornito in \ref{extract_feature}
...
\begin{table}[]
	...
	\begin{tabular}{|l|l|l|l|l|l|l|l|l|l|l|l|l|}
		\hline
		& \multicolumn{4}{c|}{Intervallo: 1} & \multicolumn{4}{c|}{Intervallo: 1.5} & \multicolumn{4}{c|}{Intervallo: 2} \\ \hline
		Ov 0.5 & 0,7 & 0,6 & 0,3 & 0,4 & 0,8 & 0,3 & 0,3 & 0,3 & 0,91 & 0,5 & 0,5 & 0,5 \\ \hline
		Ov 1 & ~ & ~ & ~ & ~ & 0,7 & 0,3 & 0,3 & 0,3 & 0,8 & 0,6 & 0,5 & 0,55 \\ \hline
		Ov 1.5 & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & 0,91 & 0,72 & 0,6 & 0,6 \\ \hline
	\end{tabular}%
}
\end{table}
%\begin{table}[]
