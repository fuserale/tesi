...
%                    continue;
 %               end
            ...
            plot(data(:,1)/1000,data(:,2+sensorpos*3+0));
...
%                    continue;
 %               end
            ...
            plot(data(:,1)/1000,data(:,2+sensorpos*3+1));
...
%                    continue;
 %               end
            ...
            plot(data(:,1)/1000,data(:,2+sensorpos*3+2));
