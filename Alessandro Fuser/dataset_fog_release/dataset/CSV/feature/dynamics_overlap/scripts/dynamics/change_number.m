...
for isubject = [1 2 3 4 8]
    for k = 5:5:45
        ...
        for p = 1:6
            ...
            %2kmeans
            if (k == 5)
                fileruns2 = dir([datadir2 alg '_2cl_dynamics_o' num2str(k,'%01d') '_3cl_S' num2str(isubject,'%02d') '*.csv']);
            else
                fileruns2 = dir([datadir2 alg '_2cl_dynamics_o' num2str(k,'%02d') '_3cl_S' num2str(isubject,'%02d') '*.csv']);
            end
            ...
            for r = 1:length(fileruns)
                ...
                print([datadir 'plot/' alg '_o' num2str(k,'%02d') '_S' num2str(isubject,'%2d') '.jpg'], '-dpng');
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                F = array2table(F);
