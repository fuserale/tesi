...
for isubject = [1 2 3 5]
    ...
    for p = 1:6
        ...
        fileruns = dir([datadir '3cl_dynamics_S' num2str(isubject,'%02d') '*.csv']);
        if p == 1
            alg = 'kmeans_cosine';
        end
        if p == 2
        ...
        fileruns2 = dir([datadir2 alg '_3cl_dynamics_S' num2str(isubject,'%02d') '*.csv']);
    ...
    writetable(P, ['../../dataset/CSV/feature/dynamics/rate/3cl_versus_S' num2str(isubject,'%02d') '.csv']);
    P = array2table(E);
    ...
    writetable(P, ['../../dataset/CSV/feature/dynamics/rate/3cl_rate_S' num2str(isubject,'%02d') '.csv']);
    display(['../../dataset/CSV/feature/dynamics/rate/3cl_rate_S' num2str(isubject,'%02d') '.csv']);
