...
fileruns = dir([datadir '3cl_dynamics_*.csv']);
...
for r = 1:length(fileruns)
    ...
    for q=1:4
        ...
        P = array2table(kidx);
        writetable(P, [datadir '/clustering/kmeans_' dist_k '_' fileruns(r).name] );
    ...
    P = array2table(nidx);
    writetable(P, [datadir '/clustering/net_' fileruns(r).name] );
    ...
    P = array2table(fidx);
    writetable(P, [datadir '/clustering/cmeans_' fileruns(r).name] );
