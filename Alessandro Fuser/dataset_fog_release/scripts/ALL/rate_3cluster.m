...
for isubject =[1 2 3 5]
    for p = 1:6
        ...
        for q=5:5:45
            ...
            fileruns2 = dir([datadir alg '_feature*.csv']);
        ...
        writetable(P, ['../../dataset/CSV/feature/interval/S' num2str(isubject,'%02d') 'R01/rate/rate_' alg '.csv'] );
        
        display(['../../dataset/CSV/feature/interval/S' num2str(isubject,'%02d') 'R01/rate/rate_' alg '.csv'] );
    end
end