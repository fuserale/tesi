...
for isubject =[1 2 3 4 8]
    for p = 1:6
        ...
        for q=5:5:45
            ...
            if q>5
                datadir = ['../../dataset/CSV/feature/interval_3cl/S' num2str(isubject,'%02d') 'R01/overlap_' num2str(q,'%02d') '/'];
            end
            ...
            fileruns2 = dir([datadir alg '_3cl_feature*.csv']);
        ...
        writetable(P, ['../../dataset/CSV/feature/interval_3cl/S' num2str(isubject,'%02d') 'R01/rate/3cl_rate_' alg '.csv'] );
        disp(['../../dataset/CSV/feature/interval_3cl/S' num2str(isubject,'%02d') 'R01/rate/3cl_rate_' alg '.csv'] );
    end
end