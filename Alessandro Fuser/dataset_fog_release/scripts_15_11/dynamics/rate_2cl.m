...
for isubject = [1 2 3 5]
    ...
    writetable(P, ['../../dataset/CSV/feature/dynamics/rate/2cl_versus_S' num2str(isubject,'%02d') '.csv']);
    P = array2table(E);
    ...
    writetable(P, ['../../dataset/CSV/feature/dynamics/rate/2cl_rate_S' num2str(isubject,'%02d') '.csv']);
