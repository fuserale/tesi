In questa cartella ci sono le prove per il prossimo incontro: 3 acc vs 1 acc con LDA

I file sono divisi in questa maniera:
	- nella cartella plot ci sono le prove per ogni paziente singolo con 3 acc ed 1 acc alla volta
