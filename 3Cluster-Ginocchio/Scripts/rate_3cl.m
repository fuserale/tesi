    ...
    for p = 1:6
        ...
        for q=5:5:45
            ...
            for r = 1:length(fileruns)
                ...
                %                 [c_matrix,Result,RefereceResult]=confusion.getMatrix(D(:,2),D(:,1));
                %                 B = [RefereceResult.AccuracyInTotal Result.Precision Result.Sensitivity Result.Specificity Result.F1_score];
                [C,T,D]=multic(D(:,2),D(:,1));
